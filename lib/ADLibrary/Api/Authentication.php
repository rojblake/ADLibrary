 ...
 *
 */
class ADLibrary_Api_Authentication extends Zikula_Api_AbstractAuthentication
{
    /**
    ...
    protected function postInitialize()
	{
        ...
        $authenticationMethod = new Users_Helper_AuthenticationMethod(
                $this->name,
                'ActiveDirectory',
                $this->__('Active Directory Account'),
                $this->__('Authenticates the user to thier Active Directory account'),
                true
        );
        ...
        $this->authenticationMethods['ActiveDirectory'] = $authenticationMethod;
    }
